...
keywords:
  ...
  - online mba entrance exam mock test free
...
```mermaid
graph LR
    A[Start: VARC 40 Mins Locked] --> B[Auto-Switch: DILR 40 Mins Locked]
    B --> C[Auto-Switch: QA 40 Mins Locked]
    C --> D[Final Submission & Instant AI Percentile Report]
```
