...
keywords: ["IIM Ahmedabad", "IIM Bangalore", "IIM Calcutta", "IIM Lucknow", "IIM Indore", "IIM Kozhikode", "IIM Mumbai", "All 21 IIMs List", "IIM Placement 2026", "CAT Cut off 2026", "IIM Admission Process", "IIM fees 2026", "IIM PGP program", "CAT percentile for IIM 2026", "new IIMs India admission", "IIM average salary package 2025"]
---
...
*   **Flagship Courses:** PGP, PGP-LSM (Liberal Studies), PGP-Finance.
*   **Placements (Avg):** ₹28.5 LPA – ₹31.0 LPA.
*   **Expected CAT Cut-off:** 98.0+ Percentile.
*   **Admission Rounds:** WAT & Personal Interview (PI).

### 7. IIM Mumbai (Formerly NITIE)
*   **Flagship Courses:** MBA, MBA (Supply Chain & Operations), MBA (Sustainability).
*   **Placements (Avg):** ₹31.0 LPA.
*   **Expected CAT Cut-off:** 97.5+ Percentile.
*   **Admission Rounds:** Personal Interview (PI).

---

### 8. IIM Shillong
*   **Flagship Courses:** PGP, PGPEx.
*   **Placements (Avg):** ₹26.0 LPA.
...
### 13. IIM Tiruchirappalli (Trichy)
*   **Flagship Courses:** PGP, PGP-HR.
*   **Placements (Avg):** ₹19.5 LPA.
*   **Expected CAT Cut-off:** 94+ Percentile (CAP Participant).
*   **Admission Rounds:** CAP Interview.
...
### 16. IIM Visakhapatnam
*   **Flagship Courses:** MBA.
*   **Placements (Avg):** ₹16.0 LPA.
*   **Expected CAT Cut-off:** 92+ Percentile.
*   **Admission Rounds:** Personal Interview (PI).
...
### Important: Common Admission Process (CAP)
Most "New" and "Baby" IIMs conduct a synchronized admission round called **CAP**. If you meet the criteria for multiple participant IIMs, you only appear for **one interview**, which is used by all of them for final selection.
