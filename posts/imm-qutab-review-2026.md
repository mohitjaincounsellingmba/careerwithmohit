...
description: >-
  ...
  Marketing & Management (IMM) Review 2026: Fees, Placements, Cutoffs & ROI
...
The table below summarizes the key metrics for **[Institute of Marketing & Management (IMM)](/colleges/imm-delhi)** for the upcoming 2026–2027 academic session:
...
| **Total Program Fee** | **₹9.45 Lakhs (Total)** |
| **Average CTC** | **₹9.5 LPA** |
| **Highest CTC** | **₹19.75 LPA** |
...
*   **Total Tuition Fee:** ₹9.45 Lakhs (Total) (payable in 4 academic installments).
...
The placement record at **[Institute of Marketing & Management (IMM)](/colleges/imm-delhi)** highlights consistent corporate trust and strong recruitment outcomes across legacy MNCs and high-growth startups.
...
*   **Solid ROI:** Strong average placement salary (**₹9.5 LPA**) compared to the total tuition fee investment (**₹9.45 Lakhs (Total)**).
...
When evaluating **Institute of Marketing & Management (IMM)**, the financial return on investment is a major differentiator. With an average starting package of **₹9.5 LPA** against a program fee of **₹9.45 Lakhs (Total)**, graduates typically recover their educational investment within **18 to 24 months** of graduating.

For aspirants looking to build a career in **Consulting, BFSI, Marketing, or Technology Management**, **Institute of Marketing & Management (IMM)** remains a top-tier recommendation in the 2026–2027 B-school landscape.
...
[InquiryCard title="Get Direct Admission Counseling for Institute of Marketing & Management (IMM)" subtitle="Verify your eligibility, check cutoff percentiles, and download official placement brochures instantly." ctaText="Apply Now / Check Eligibility"]

---

## 8. Frequently Asked Questions (FAQs)

### Q1. What is the average salary package at Institute of Marketing & Management (IMM) in 2026?
The average package offered during campus placements at **Institute of Marketing & Management (IMM)** is approximately **₹9.5 LPA**, with top quartile students securing significantly higher packages up to **₹19.75 LPA**.

### Q2. Which entrance exams are accepted for MBA/PGDM admission at Institute of Marketing & Management (IMM)?
**Institute of Marketing & Management (IMM)** accepts scores from **CAT, XAT, CMAT, MAT, ATMA** for shortlisting applicants for its 2-year full-time management programs.

### Q3. What is the total fee for the MBA program at Institute of Marketing & Management (IMM)?
The total tuition fee for the complete 2-year program is **₹9.45 Lakhs (Total)**. Additional charges apply for hostel accommodations and mess facilities.

### Q4. Does Institute of Marketing & Management (IMM) provide scholarships or financial aid?
Yes, **Institute of Marketing & Management (IMM)** offers merit-based scholarships and fee waivers for top entrance exam percentile scorers and economically disadvantaged candidates with outstanding academic records.
