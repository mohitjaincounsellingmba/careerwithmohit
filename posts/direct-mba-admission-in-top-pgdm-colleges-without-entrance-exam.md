...
```mermaid
graph TD
    A[Step 1: Check Minimum Eligibility - 50% in UG] --> B[Step 2: Shortlist AICTE Approved B-Schools]
    B --> C[Step 3: Submit Application with Academic Transcripts]
    C --> D[Step 4: Attend Online / Offline GD-PI Round]
    D --> E[Step 5: Receive Provisional Offer Letter]
    E --> F[Step 6: Pay Seat Booking Fee & Confirm Admission]
```
