...
keywords:
  ...
  - BMU Gurgaon MBA fees and placements
...
```mermaid
graph TD
    A[Step 1: Check Eligibility 50%+ in Graduation] --> B[Step 2: Submit Valid CAT/NMAT/XAT/GMAT or BMU-MAT]
    B --> C[Step 3: Submit Online BMU Application Form]
    C --> D[Step 4: Shortlisting Based on Academic Profile & Scores]
    D --> E[Step 5: Case Analysis & Personal Interview with Faculty Panel]
    E --> F[Step 6: Provisional Admission Offer & Scholarship Sanction]
    F --> G[Step 7: Fee Payment & Enrollment in July Batch]
```
