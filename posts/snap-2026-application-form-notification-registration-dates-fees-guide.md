...
keywords:
  ...
  - SNAP registration 2026
  - SNAP 2026 registration dates
  - SNAP application form 2026
  - Symbiosis National Aptitude Test notification
...
```mermaid
graph TD
    A[Total Application Expense] --> B[1. SNAP Test Registration Fee]
    A --> C[2. Programme Registration Fee]
    B --> B1[₹2,250 - ₹2,550 per attempt]
    C --> C1[₹1,000 per institute / programme]
```
...
* In addition to the test fee, you must apply to individual Symbiosis institutes and programmes (e.g., SIBM Pune MBA, SCMHRD MBA-HR, SIBM Bangalore MBA).
...
```mermaid
pie title SNAP 2026 Marks & Question Distribution
    "General English (15 Marks)" : 15
    "Analytical & Logical Reasoning (25 Marks)" : 25
    "Quantitative, DI & DS (20 Marks)" : 20
```
