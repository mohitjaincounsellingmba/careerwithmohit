...
keywords:
  ...
  - iim placement 2025 average package
  - iim highest package 2025
  - iim placement statistics 2025
  - old iims vs new iims vs baby iims placements 2025
  - iim ahmedabad placement report 2025
  - iim bangalore placement 2025
  - iim calcutta placement report 2025
...
```mermaid
graph TD
    A[All 21 IIMs - 2025 Placement Cycle] --> B[Old IIMs + IIM Mumbai]
    A --> C[New IIMs - Gen 2]
    A --> D[Baby IIMs - Gen 3]
    
    B --> B1[Avg: ₹28 - 35 LPA]
    B --> B2[Marquee Global Offers]
    B --> B3[Top: Consulting & IB]
    
    C --> C1[Avg: ₹17.5 - 27 LPA]
    C --> C2[Strong Corporate Standing]
    C --> C3[Top: Strategy, BFSI & Analytics]
    
    D --> D1[Avg: ₹13 - 19.7 LPA]
    D --> D2[Rapid Infrastructure Expansion]
    D --> D3[Top: BFSI, ITES & Operations]
```
...
```mermaid
pie title Domain-Wise Share in IIM Placements 2025
    "Management Consulting & Strategy" : 38
    "BFSI & Investment Banking" : 24
    "Product Mgmt & Big Tech" : 15
    "FMCG / Retail / Conglomerates" : 13
    "General Mgmt & Operations" : 10
```
