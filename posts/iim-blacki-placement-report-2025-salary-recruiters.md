...
keywords:
  ...
  - iim indore placement report 2025
  - iim mumbai nitie placement 2025
...
```mermaid
graph LR
    A[Elite Tier Old IIMs] --> B[IIMA: Strategy & Consulting Pioneer]
    A --> C[IIMB: Tech Strategy & Product Capital]
    A --> D[IIMC: Undisputed Finance & Quant Hub]
    A --> E[IIML & IIM Mumbai: Ops & General Leadership]
...
```mermaid
pie title Old IIMs Placement Sources 2025
    "Pre-Placement Offers (PPOs)" : 46
    "Lateral Placement Process (Ex-Experience)" : 32
    "Final Placement Week" : 22
```
