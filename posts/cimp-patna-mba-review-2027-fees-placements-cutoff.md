...
keywords:
  ...
  - chandragupt institute of management patna (cimp) admission process 2027
  - chandragupt institute of management patna (cimp) ranking
  - Mithapur MBA colleges 2027
  - best MBA colleges in Patna
...
# [Chandragupt Institute of Management Patna (CIMP)](/colleges/cimp-patna) Review 2027: Fees, Placements, Cutoff, Ranking & Honest Verdict
...
> - **Total Fee Investment**: Verified at **₹8.65 Lakhs (Total)** for the complete full-time postgraduate curriculum.
> - **Placement & ROI Benchmark**: Average placement salary stands at **₹7.80 LPA** (Highest package: **₹21.50 LPA**; Median package: **₹5.50 LPA**) featuring premier recruiters like Amul, ITC, KPMG, HDFC Bank.
...
Here is a consolidated overview of **[Chandragupt Institute of Management Patna (CIMP)](/colleges/cimp-patna)**:

| Parameter | Official Verified Details |
| :--- | :--- |
| **Institution Name** | **[Chandragupt Institute of Management Patna (CIMP)](/colleges/cimp-patna)** |
| **Campus Location** | Mithapur, Patna, Bihar |
| **Year Established** | 2008 |
| **Institution Type & Ownership** | Government Autonomous (Govt. of Bihar Supported) |
| **Accreditation & Approvals** | NIRF Top 100 B-School in India · NBA & AIU Equivalent |
| **Flagship Programs** | PGDM (AICTE Approved), Fellow Programme in Management |
| **Accepted Entrance Exams** | CAT, XAT, CMAT |
| **Total Course Fee** | **₹8.65 Lakhs (Total)** |
| **Average Placement Package** | **₹7.80 LPA** |
| **Highest Placement Package** | **₹21.50 LPA** |
| **Median Package Benchmark** | **₹5.50 LPA** |
| **Top Recruiting Partners** | Amul, ITC, KPMG, HDFC Bank, Tata AIA, Airtel |
...
- **Total Course Fee Estimate:** **₹8.65 Lakhs (Total)** for the complete 2-year full-time curriculum.
...
- **Marquee Recruiters:** Amul, ITC, KPMG, HDFC Bank, Tata AIA, Airtel, Yes Bank.
...
- **Fellow Programme in Management**: Rigorous curriculum designed in collaboration with corporate industry advisory boards.
...
| :--- | :--- | :--- | :--- |
| **[Chandragupt Institute of Management Patna (CIMP)](/colleges/cimp-patna)** | **₹8.65 Lakhs (Total)** | **₹7.80 LPA** | **Balanced ROI with strong regional corporate connections** |
...
## 8. Final Admission Verdict: Should You Join Chandragupt Institute of Management Patna (CIMP)?

### Why Choose Chandragupt Institute of Management Patna (CIMP)?
1. **Solid Placement Track Record:** Consistent average CTC of **₹7.80 LPA** with blue-chip recruiters.
2. **Accredited Academic Quality:** Backed by **NIRF Top 100 B-School in India · NBA & AIU Equivalent** and seasoned faculty.
3. **Strategic Regional Advantage:** Located in **Mithapur, Patna, Bihar**, offering extensive industrial and corporate interface.
...
### Q1. What is the average package at Chandragupt Institute of Management Patna (CIMP)?
The overall average placement package at Chandragupt Institute of Management Patna (CIMP) stands at approximately **₹7.80 LPA**, with top domestic packages touching **₹21.50 LPA**.

### Q2. Which entrance exams are accepted by Chandragupt Institute of Management Patna (CIMP)?
Chandragupt Institute of Management Patna (CIMP) accepts scores from **CAT, XAT, CMAT** for shortlisting candidates for its flagship management programs.

### Q3. What is the total fee for the MBA / PGDM program?
The total course fee structure is approximately **₹8.65 Lakhs (Total)** for the complete 2-year full-time curriculum.

### Q4. How can I get 1-on-1 counseling for Chandragupt Institute of Management Patna (CIMP) admission?
