...
keywords:
  ...
  - MBA admission 2027-29 fees
  - PGDM vs MBA fees and placements 2027
  - NDIM Delhi fees placements 2027
  - Fostiima Delhi PGDM fees
  - FIIB Delhi admission 2027
  - DSB Pitampura Delhi PGDM
  - IILM Lodhi Road Delhi fees
  - JIMS Kalkaji PGDM placements
  - RIIM Pune fees 2027
  - Lexicon MILE Pune placements
  - DY Patil Pune MBA
  - ITM Navi Mumbai PGDM
  - ATLAS SkillTech Mumbai MBA
  - ISBR Bangalore MBA PGDM
  - GIBS Bangalore fees
  - ISME Bangalore PGDM
...
```mermaid
graph TD
    A["Management Aspirant (2027-29)"] --> B{"Course Choice"}
    B -->|"University Degree Track"| C["MBA (Master of Business Administration)"]
    B -->|"Autonomous Industry Track"| D["PGDM (Post Graduate Diploma in Management)"]
    C --> C1["Governed by UGC & University Syllabus"]
    C --> C2["Academic & Theoretical Rigor"]
    C --> C3["Lower to Moderate Fee Structure"]
    D --> D1["Governed by AICTE & Industry Advisory Board"]
    D --> D2["Dynamic, Industry-Updated Curriculum"]
    D --> D3["Mandatory AIU Equivalence for MBA Status"]
    D --> D4["Higher Corporate Exposure & Live Projects"]
```
...
sequenceDiagram
    autonumber
    actor Student as Management Aspirant
    participant Portal as Online Application
    participant Exam as Entrance Test (CAT/XAT/CMAT/MAT)
    participant GDPI as GD-PI & Extempore Round
    participant Merit as Offer Letter & Scholarship
    participant Campus as Induction & Onboarding

    Student->>Portal: Shortlist Target B-Schools & Submit Application
    Student->>Exam: Submit Valid Scorecard (CAT/XAT/MAT/CMAT/ATMA)
    Portal->>GDPI: Profile Screening & GD-PI Interview Call
    GDPI->>Merit: Evaluation of Academics, Work-Ex, GD & PI Scores
    Merit->>Student: Provisional Admission Letter with Scholarship Rebate
    Student->>Campus: Token Fee Payment & 2027-29 Batch Registration
```
