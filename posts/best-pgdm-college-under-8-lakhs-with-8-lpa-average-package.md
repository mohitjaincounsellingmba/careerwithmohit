...
keywords:
  ...
  - mba colleges with 100 percent roi
...
```mermaid
graph TD
    A[Budget Under 8 Lakhs] --> B[Government University Departments]
    A --> C[Private AICTE Approved PGDM]
    B --> B1[Ultra Low Fees: 50K - 2.5L]
    B --> B2[High Entrance Cutoff: 88-99%ile]
    B --> B3[Colleges: FMS BHU, SIMSREE, PUMBA, UBS]
    C --> C1[Moderate Fees: 6.5L - 8.5L]
    C --> C2[Accessible Cutoffs: 60-80%ile / Profile]
    C --> C3[Colleges: FOSTIIMA, JIMS, NDIM, XIME]
```
