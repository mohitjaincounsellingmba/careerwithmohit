...
keywords:
  ...
  - fore vs lbsim placement comparison
...
```mermaid
graph TD
    A[Choose Your Priority] --> B[Aiming for Brand FMCG / Global Marketing?]
    A --> C[Aiming for Consulting / Analytics in Delhi?]
    A --> D[Aiming for Core Finance / Low Debt Burden?]
    B --> E[Select: IMT Ghaziabad]
    C --> F[Select: FORE School of Management]
    D --> G[Select: LBSIM New Delhi]
```
