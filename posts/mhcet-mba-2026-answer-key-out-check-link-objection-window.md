...
## How to Raise Objections? (Fee & Process)

If you believe a question or its official answer is incorrect, you can challenge it through the portal.

*   **Objection Fee:** ₹1,000 per question.
*   **Refund Policy:** The fee is generally non-refundable, even if the objection is found valid.
*   **Deadline:** May 4, 2026 (upto 5:00 PM).
*   **Documentation:** You must provide a valid reference or justification (from standard textbooks) to support your claim.

---

## What is a Safe Score for JBIMS? (Marks vs Percentile)

Since MHCET 2026 Phase 1 was reported to be of moderate difficulty, the cutoffs for top-tier institutes like JBIMS and SIMSREE are expected to remain high. 

| Institute | Expected Percentile | Safe Score (Raw) |
|-----------|---------------------|------------------|
| **JBIMS, Mumbai** | 99.99+ | 158+ |
| **SIMSREE, Mumbai** | 99.95+ | 148+ |
| **PUMBA, Pune** | 99.60+ | 138+ |
...
- The types of Quant questions being prioritized by the CET Cell this year.
