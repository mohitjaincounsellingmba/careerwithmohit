...
keywords:
  ...
  - IMS Ghaziabad PGDM CAT MAT cutoff
...
```mermaid
graph TD
    A[CAT Score: 70 - 75 Percentile] --> B[Equivalent MAT Score: 75 - 82 Percentile]
    A --> C[Equivalent CMAT Score: 75 - 85 Percentile]
    D[CAT Score: 76 - 80 Percentile] --> E[Equivalent MAT Score: 83 - 90 Percentile]
    D --> F[Equivalent CMAT Score: 86 - 92 Percentile]
```
