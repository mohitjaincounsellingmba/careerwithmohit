...
date: '2026-05-28'
description: >-
  Comprehensive expert analysis and 2026-2027 admission guide for Zara (Inditex)
  Case Study: JIT Production & Agile Fast-Fashion Supply Chain. Check updated
...
| Operational Dimension | Traditional Retail (Push Model) | Zara / Inditex (Pull Model) |
| :--- | :--- | :--- |
| **Design-to-Shelf Lead Time** | 6 - 9 Months | **10 - 15 Days** |
| **Outsourced Production** | 80% to 100% (mostly Asia) | **Low (50% local in Spain/Portugal/Morocco)** |
| **Batch Sizes** | Massive bulk orders | **Very Small, limited-run batches** |
| **Unsold Inventory / Markdowns** | 15% to 20% of stock | **Less than 8% of stock** |
| **Store Deliveries** | Once every few weeks | **Twice a week (regular as clockwork)** |
| **Advertising Budget** | 3% to 4% of sales | **Almost Zero (0.3% of sales)** |
