...
keywords:
  ...
  - isb hyderabad pgp eligibility gmat cutoff
...
```mermaid
graph TD
    A[Choose Based on Career Goals] --> B[7+ Yrs Exp: Director, VP, General Management]
    A --> C[2-5 Yrs Exp: Management Consulting / Product Management]
    B --> D[Target: IIM Ahmedabad PGPX]
    C --> E[Target: ISB Hyderabad / Mohali]
```
