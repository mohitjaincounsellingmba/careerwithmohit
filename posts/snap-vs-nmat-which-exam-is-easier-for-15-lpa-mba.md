...
```mermaid
graph TD
    A[Which Exam Suits You Better?] --> B[Do you panic under rapid time pressure?]
    A --> C[Do you prefer guessing without negative penalties?]
    A --> D[Are you strong at quick mental logic puzzles?]
    B -->|Yes| E[Choose NMAT: 120 Mins, Generous Sectional Time]
    C -->|Yes| E
    D -->|Yes| F[Choose SNAP: 60 Qs in 60 Mins, Straightforward]
```
