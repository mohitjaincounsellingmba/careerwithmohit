...
keywords:
  ...
  - NDIM cutoff CAT MAT CMAT 2027
  - NDIM Delhi PGDM fees 2027-29
...
```mermaid
graph TD
    A["Step 1: Fill Online Application Form & Pay ₹1,000 Fee"] --> B["Step 2: Submit Academic Records & Entrance Scorecard"]
    B --> C["Step 3: Profile Screening & Shortlisting Call"]
    C --> D["Step 4: Group Discussion (GD) & Personal Interview (PI)"]
    D --> E["Step 5: Composite Scoring & ₹2.5 Cr Scholarship Evaluation"]
    E --> F["Step 6: Provisional Offer Letter & Seat Acceptance"]
```
...
```mermaid
graph TD
    A[NDIM ₹2.5 Cr Scholarship Corpus] --> B[Merit-Based Waivers]
    A --> C[Special Category Rebates]
    B --> B1[90%+ in CAT/XAT -> High Tuition Waiver]
    B --> B2[80%+ in MAT/CMAT -> Sizable Scholarship]
    B --> B3[Outstanding Academic Record in 10th, 12th & Degree]
    C --> C1[Wards of Armed Forces & Paramilitary]
    C --> C2[Siblings of NDIM Alumni & Current Students]
    C --> C3[Graduates of NDIM BBA / B.Com]
    C --> C4[Students from J&K and North-Eastern States]
    C --> C5[Wards of Single Parents & Reserved Categories]
```
