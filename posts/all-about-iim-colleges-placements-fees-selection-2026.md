...
keywords:
  ...
  - all 21 IIMs placements
  - IIM lowest average highest package
  - IIM affiliation and approved by
  - IIM Act 2017
  - IIM unique selling proposition USP
  - IIM selection criteria 2026
  - IIM CAT cutoff 2026
...
```mermaid
graph TD
    A[Parliament of India] -->|IIM Act, 2017| B[Ministry of Education, Govt of India]
    B -->|Statutory Autonomy| C[Board of Governors - Each IIM]
    C -->|Empowered to Award| D[MBA Degree / MBA-BA / MBA-HRM]
    C -->|Global Accreditations| E[AACSB / EQUIS / AMBA - Triple Crown]
```
...
mindmap
  root((IIM Brand USPs))
    Lifetime Brand Equity
      Global Alumni Network
      C-Suite Leadership
    Unbeatable ROI
      35+ LPA Average at Old IIMs
      100% Final Placements
    Case-Study Pedagogy
      Harvard Business School Method
      Live Industry Consultancies
    Global Exchange STEP
      Wharton / INSEAD / HEC Paris
      Dual Degree Options
    Startup Ecosystem
      Multi-Crore Incubation Funds
      Zero-Day Placement Deferral
```
