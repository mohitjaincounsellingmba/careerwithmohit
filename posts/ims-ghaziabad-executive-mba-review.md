...
- **Official Course Name:** PGDM Executive (15-Month Program)
- **Approximate Fees:** ₹4.50 Lakhs (Total Fees)
- **Entrance Exams Accepted:** CAT/XAT/CMAT/MAT + Personal Interview
...
- **Academic Requirements:** Graduation with min 50% + minimum 5 years of post-qualification work experience.
...
- **Estimated Placements:** Lateral career assistance, average package hovers around ₹8.50 LPA.
...
### Pros
- **Highlight:** Reasonable fee structure for an intensive 15-month program.
- **Highlight:** Strong local industry connections in the Ghaziabad industrial belt.
- **Highlight:** Focus on business analytics and corporate case studies.

### Cons
- **Limitation:** Brand perception is tier-2 compared to IMT Ghaziabad.
- **Limitation:** Limited international exchange opportunities.

---

## 🔍 Our Expert Verdict

The Executive MBA program at [IMS Ghaziabad](/colleges/ims-ghaziabad) is highly recommended for professionals based in Ghaziabad who want to scale their careers without disrupting their current geographic setup. 
...
### What is the duration of the IMS Ghaziabad Executive program?
It is a fast-track 15-month program designed to complete core studies in 12 months with a 3-month dissertation project.

### What is the minimum work experience required for IMS?
A minimum of 5 years of full-time professional experience is required to apply.
