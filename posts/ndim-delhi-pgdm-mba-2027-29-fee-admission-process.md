...
keywords:
  ...
  - NDIM Delhi fee structure 2027-29
...
```mermaid
graph TD
    A[NDIM ₹2.5 Crore Fund Pool] --> B[Merit-Based Scholarships]
    A --> C[Social & Category Rebates]
    B --> B1[High Percentiles in CAT, XAT, MAT, CMAT, ATMA, GMAT]
    B --> B2[Outstanding Academics in 12th & Graduation]
    C --> C1[Wards of Defence & Paramilitary Forces]
    C --> C2[Siblings of NDIM Students / Alumni]
    C --> C3[NDIM BBA / B.Com Graduates]
    C --> C4[Students from J&K and North-Eastern States]
    C --> C5[Wards of Single Parents]
    C --> C6[SC / ST / OBC / EWS Category Candidates]
```
...
```mermaid
graph LR
    A[1. Online Application Form & ₹1000 Fee] --> B[2. Entrance Exam & Profile Screening]
    B --> C[3. GD & Case Analysis Round]
    C --> D[4. Personal Interview PI]
    D --> E[5. Composite Merit List & Offer Letter]
```
