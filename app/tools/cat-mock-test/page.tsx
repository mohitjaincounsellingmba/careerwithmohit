...
export const metadata: Metadata = {
  ...
  keywords: [
    ...
    'CAT 2026 study plan for working professionals', 'CAT score vs percentile 2026', 'IIM admission criteria 2026', 
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
               ...
               <div className="space-y-4">
                 ...
                 <ul className="space-y-2 text-sm font-bold text-gray-600 italic">
                   ...
                   <li><ArrowRight className="inline w-3 h-3 mr-1 text-primary"/> IIM admission criteria 2026</li>
