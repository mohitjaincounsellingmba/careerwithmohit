...
const TOOL_CATEGORIES = [
  ...
  },
  {
    ...
    tools: [
      ...
      { name: 'Sept MAT Score Calculator & Checker', desc: 'September MAT composite score (out of 800) & percentile', href: '/tools/mat-score-calculator', badge: 'Popular', color: 'text-green-600' },
