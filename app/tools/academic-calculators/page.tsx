...
export default function AcademicCalculatorsPage() {
  ...
  return (
    <div className="min-h-screen bg-slate-50 py-12 lg:py-24 font-sans">
      <Head>
        <title>Academic Calculators | CGPA to Percentage | SGPA to CGPA</title>
        <meta name="description" content="Free academic calculators for students: Convert CGPA to Percentage, calculate CGPA from SGPA, and convert Grades to Percentage accurately." />
      </Head>
