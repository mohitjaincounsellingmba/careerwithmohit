...
export const metadata: Metadata = {
  ...
  keywords: [
    'XAT mock test 2027', 'xat 2027', 'XLRI Jamshedpur decision making practice 2027', 'free XAT online test series 2027', 
  ...
  twitter: {
    ...
    title: 'Free XAT Mock Test 2027 | XLRI Prep',
      ...
      <div className="mx-auto max-w-6xl">
        ...
        <div className="mb-10 text-center">
          <h1 className="text-4xl sm:text-6xl md:text-7xl font-black uppercase mb-4 leading-none tracking-tight">
            Free XAT <span className="text-emerald-700 italic">2027</span> Mock Test
          </h1>
