...
import { ShieldCheck, Zap, HelpCircle, BookOpen, GraduationCap, TrendingUp } from "lucide-react";
import Link from "next/link";

export function CuetUgPageContent() {
        ...
        <div className="min-h-screen bg-slate-50 font-body">
            ...
            <div className="max-w-7xl mx-auto px-6 pt-10">
              <div className="flex gap-4 mb-0">
                <button
                  className={`px-6 py-2 rounded-t-lg font-bold ${activeTab === 'score' ? 'bg-primary text-white' : 'bg-gray-200 text-gray-800'}`}
                  onClick={() => setActiveTab('score')}
                >
                  Score Check
                </button>
                <button
                  className={`px-6 py-2 rounded-t-lg font-bold ${activeTab === 'inquiry' ? 'bg-primary text-white' : 'bg-gray-200 text-gray-800'}`}
