...
cities.forEach(city => {
  const slug = `best-online-mba-colleges-in-${city.toLowerCase().replace(/[^a-z0-9]+/g, '-').replace(/(^-|-$)/g, '')}-2026`;
...
console.log(`\n🎉 Success! Programmatically generated ${generatedCount} online MBA blog posts in the 'posts' directory.`);
