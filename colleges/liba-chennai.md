...
Loyola Institute of Business Administration (LIBA) is an internationally respected Jesuit B-School in Chennai focused on ethics-led leadership, social responsibility, and robust corporate placement performance.
...
- **Highest Placement Package**: ₹22.50 LPA
- **Median Package Estimate**: ₹8.00 LPA
- **Top Recruiting Partners**: Cognizant, Deloitte, Morgan Stanley, Infosys, ITC, Bank of America, BMW

### Admission Process & Eligibility
- **Accepted Entrance Exams**: CAT, XAT
- **Accreditation & Approvals**: Top Tier B-School South India · SAQS Accredited
- **Ownership Structure**: Private Jesuit Autonomous
- **Total Course Fee Estimate**: ₹17.20 Lakhs (Total)
