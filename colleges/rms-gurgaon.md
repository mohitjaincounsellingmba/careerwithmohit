...
- **PGDM Global**: A premium program with international immersion.
- **Specializations**: Marketing, Finance, HR, and Supply Chain Management.

### Placements 2024-25
- **Highest Package**: ₹23.00 LPA
- **Average Package**: ₹6.50 LPA
- **Placement Rate**: 99%
- **Top Recruiters**: Amazon, IBM, VI, Reliance Digital, TATA 1mg, Genpact, FedEx, HCL, Axis Bank, Kotak.

### Admission Process
1. **Entrance Merit**: Evaluation based on CAT/MAT/CMAT scores.
2. **GD/PI Round**: Interactive assessment of business acumen.
3. **Counseling**: Career guidance for choosing the right specialization.
