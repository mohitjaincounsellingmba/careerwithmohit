...
IIIT Sri City is strategically located in the Sri City Special Economic Zone bordering Chennai. Offers high-level coding, modern curriculum designed with IIIT Hyderabad guidance, and outstanding placements.
...
- **Highest Placement Package**: ₹51.00 LPA
- **Median Package Estimate**: ₹9.00 LPA
- **Top Recruiting Partners**: Amazon, Google, Microsoft, Swiggy, PhonePe, Commvault, Deloitte

### Admission Process & Eligibility
- **Accepted Entrance Exams**: JEE Main (Top 98.5%ile), DASA, GATE
- **Accreditation & Approvals**: Top Emerging IIIT in South India
- **Ownership Structure**: Institute of National Importance (PPP Mode)
- **Total Course Fee Estimate**: ₹12.00 - ₹14.50 Lakhs (Total 4 Years)
