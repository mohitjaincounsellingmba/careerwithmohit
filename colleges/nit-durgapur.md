...
NIT Durgapur is Eastern India's premier National Institute of Technology, nestled in the industrial hub of Durgapur. Famous for strong academic rigor, high software recruitment, and premier public sector undertakings (PSU) recruitment.
...
- **Average Placement Package**: ₹13.60 LPA
- **Highest Placement Package**: ₹70.00 LPA
- **Median Package Estimate**: ₹8.00 LPA
- **Top Recruiting Partners**: Amazon, Microsoft, Qualcomm, JPMorgan Chase, Wells Fargo, Tata Motors, Schneider Electric

### Admission Process & Eligibility
- **Accepted Entrance Exams**: JEE Main, DASA, GATE
- **Accreditation & Approvals**: NIRF Rank #43 (Engineering 2024)
