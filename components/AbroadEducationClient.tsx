...
const COUNTRIES = ['All', 'USA', 'Canada', 'UK', 'Ireland', 'Germany', 'Sweden', 'Netherlands', 'France', 'Finland', 'Malta', 'New Zealand', 'Australia', 'Dubai', 'India (Global)'];
const FEE_RANGES = [
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-8 mb-12">
          <div>
            ...
            <p className="text-gray-500 font-medium max-w-xl">
              Compare 380+ top universities from the UK, USA, Canada, Australia, New Zealand, Ireland, Germany, Sweden, Netherlands, France, Finland, Malta, and Dubai. Filter by budget, country, and accreditation to find your perfect match.
            </p>
          </div>
          <button
