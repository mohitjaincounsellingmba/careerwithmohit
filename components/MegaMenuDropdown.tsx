...
export function MegaMenuDropdown({ item, onClose }: MegaMenuDropdownProps) {
  ...
  return (
    <div 
      className="absolute top-full left-0 right-0 z-50 bg-white border-t border-b border-slate-200 shadow-2xl animate-in fade-in slide-in-from-top-1 duration-150"
    ...
    >
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-5">
        <div className="grid grid-cols-12 gap-5 min-h-[380px]">
          ...
          <div className="col-span-3 border-r border-slate-200/80 pr-3 flex flex-col justify-start gap-0.5">
                ...
                return (
                  <button
                    ...
                    className={`w-full text-left px-3 py-2 rounded-xl text-[13px] font-semibold transition-all flex items-center justify-between group cursor-pointer ${
                      isActive
                        ? "bg-blue-50/90 text-blue-700 font-bold shadow-xs ring-1 ring-blue-500/10"
          ...
          <div className="col-span-5 border-r border-slate-200/80 pr-5 pl-2 flex flex-col justify-between">
            <div>
                ...
                {activeCategory.links.map((link) => {
                  ...
                  return (
                    <Link
                      ...
                      onClick={onClose}
                      {...linkProps}
                      className="px-2.5 py-2 rounded-lg hover:bg-blue-50/70 text-slate-700 hover:text-blue-700 transition-colors flex items-center justify-between gap-1.5 group text-left"
                    >
          ...
          <div className="col-span-4 pl-1 flex flex-col justify-between gap-3">
              ...
              <div className="flex flex-col gap-2">
                {item.featuredColleges.map((col) => (
                  <Link
                    ...
                    href={col.href}
                    onClick={onClose}
                    className="p-2.5 rounded-xl border border-slate-200/80 hover:border-blue-300 bg-slate-50/50 hover:bg-white transition-all shadow-2xs hover:shadow-sm group flex flex-col gap-1 text-left"
                  >
                    <div className="flex items-start justify-between gap-2">
                      ...
                      <span
                        className={`text-[9px] font-bold px-1.5 py-0.2 rounded shrink-0 ${
                          col.badgeColor || "bg-emerald-50 text-emerald-700 border border-emerald-200"
                        }`}
                      >
                        {col.badge}
                      </span>
                    ...
                    <div className="flex items-center justify-between text-[10.5px] text-slate-700">
                      ...
                      {col.packageInfo && (
                        <span className="text-emerald-700 font-semibold shrink-0 ml-1">
            ...
            {item.promoBanner && (
              <div className="p-3 rounded-2xl bg-gradient-to-br from-slate-900 via-indigo-950 to-blue-950 text-white shadow-md relative overflow-hidden flex items-center justify-between gap-3">
