...
const SPEC_MAP: Record<string, string[]> = {
  Management: ["Marketing", "Finance", "Human Resources (HR)", "Operations & Supply Chain", "International Business", "IT & Systems", "Entrepreneurship", "Healthcare Management"],
  Engineering: ["Computer Science (CSE)", "AI & Machine Learning", "Data Science", "Electronics & Communication (ECE)", "Mechanical Engineering", "Civil Engineering", "Information Technology"],
  "UG Courses": ["Commerce", "Arts", "Science", "Law", "Computer Applications", "Pharmacy"],
};
