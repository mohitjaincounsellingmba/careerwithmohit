  ...
  return (
    <div className="min-h-screen bg-slate-50 pb-32 text-slate-900 selection:bg-blue-600 selection:text-white">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 -mt-8 relative z-30">
        ...
        {/* Pan-India State Explorer - Only displayed when not actively searching */}
        {(selectedCategory === "All Streams" || selectedCategory === "Management" || selectedCategory === "Engineering") && !searchQuery.trim() && (
                ...
                <div className="flex flex-wrap items-center gap-2 mb-2">
                  <div className="inline-flex items-center gap-1.5 px-2.5 py-0.5 rounded-full bg-blue-50 border border-blue-200 text-blue-700 text-[10px] font-bold uppercase tracking-wider">
                    ...
                    {selectedCategory === "Engineering" || (selectedCategory === "All Streams" && stateExplorerStream === 'engineering')
                      ? "Pan-India B.Tech & M.Tech Directory" 
                      : "Pan-India MBA Directory"}
                  </div>
        ...
        <div className="flex flex-col lg:flex-row gap-8">
          ...
          <main className="w-full lg:w-3/4">
            ...
            {searchQuery.trim().length > 0 && (
              <div className="mb-6 p-4 sm:p-5 bg-gradient-to-r from-blue-600 via-indigo-600 to-blue-700 rounded-2xl text-white shadow-lg shadow-blue-500/20 flex flex-col sm:flex-row sm:items-center justify-between gap-3 animate-in fade-in duration-200">
                  ...
                  <div>
                    <h2 className="text-base sm:text-lg font-black tracking-tight text-white flex items-center gap-2">
                      ...
                      <span className="text-xs bg-amber-400 text-slate-950 font-black px-2 py-0.5 rounded-full uppercase">
                        {filteredColleges.length} {filteredColleges.length === 1 ? "Result" : "Results"}
                      </span>
                    </h2>
                    <p className="text-xs text-blue-100/90 mt-0.5">
                      Showing matching colleges verified with audited fees, entrance cutoffs, and placements.
                    </p>
                  </div>
                </div>
                <button
                  ...
                  className="self-start sm:self-center px-4 py-2 rounded-xl bg-white hover:bg-white/90 text-blue-700 font-extrabold text-xs shadow-sm transition-all cursor-pointer flex items-center gap-1.5 shrink-0"
                >
                  <X className="w-3.5 h-3.5" />
