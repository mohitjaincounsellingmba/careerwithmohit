          ...
          {!isSuccess && (
            <div className="mt-6 flex items-center gap-4">
              <button
                ...
                className={`flex items-center gap-2 rounded-md px-4 py-2 font-bold text-sm transition-all ${
                  method === 'email' 
            ...
            <form onSubmit={handleSubmit} className="w-full relative">
              <div className="relative flex items-center justify-between p-1 bg-white border-2 border-gray-200 rounded-lg shadow-sm focus-within:border-primary focus-within:ring-4 focus-within:ring-primary/10 transition-all group">
                ...
                <button
                  ...
                  className={`flex h-12 w-32 items-center justify-center rounded-md font-bold text-white transition-all hover:scale-105 active:scale-95 disabled:scale-100 disabled:opacity-70 ${
                    method === 'whatsapp' ? 'bg-[#25D366] hover:bg-[#128C7E]' : 'bg-foreground hover:bg-gray-800'
                  }`}
                >
                  {isSubmitting ? (
