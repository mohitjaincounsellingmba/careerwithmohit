        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-6 gap-12 mb-12 border-b-2 border-gray-800 pb-12 overflow-hidden">
          ...
          <div className="space-y-8">
            ...
            <div className="pt-8 border-t border-gray-800">
              ...
              <ul className="mt-4 space-y-4 text-xs font-bold">
                <li><Link href="/learn-skills" prefetch={false} className="text-emerald-400 hover:text-white transition-colors">HTML Tutorial</Link></li>
                <li><Link href="/learn-skills" prefetch={false} className="text-yellow-400 hover:text-white transition-colors">CSS Tutorial</Link></li>
                <li><Link href="/learn-skills" prefetch={false} className="text-cyan-400 hover:text-white transition-colors">JavaScript</Link></li>
                <li><Link href="/learn-skills" prefetch={false} className="text-orange-400 hover:text-white transition-colors">Python</Link></li>
