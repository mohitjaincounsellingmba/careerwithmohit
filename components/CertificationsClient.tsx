...
import { CERTIFICATIONS_DATA, type Course, type CourseType } from '@/data/certificationsData';

export type { Course, CourseType };
export { CERTIFICATIONS_DATA };
...
export function CertificationsClient() {
  ...
  const filteredCourses = activeFilter === 'all'
    ? CERTIFICATIONS_DATA
    : CERTIFICATIONS_DATA.filter(c => c.type === activeFilter);
      ...
      <section className="bg-white border-b-8 border-foreground py-20 px-6 sm:px-12">
        <div className="mx-auto max-w-7xl text-center">
          ...
          <p className="max-w-2xl mx-auto text-2xl font-bold text-gray-700 leading-tight mb-8">
            Browse through our curated list of high-quality free and premium certification courses in Python, Digital Marketing, AI, and Finance.
          </p>
            ...
            {filteredCourses.map((course) => {
              ...
              return (
                ...
                >
                  ...
                  {/* Header */}
                  <h2 className="text-2xl font-black text-foreground uppercase mb-2 leading-tight min-h-[3.5rem]">
                    {course.title}
                  </h2>
